                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="number" name="bathNumber" id="bathNumber" class="form-control" required
                ...
                <div class="modal-body">
                    <form id="editPropertyForm" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editPropertyName" name="propertyName"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="editPropertyType" class="form-label text-dark">Property Type</label>
                            <input type="text" class="form-control" id="editPropertyType" name="propertyType"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editPropertyPrice" name="propertyPrice"
                                required>
                        </div>
                        <div class="mb-3">
